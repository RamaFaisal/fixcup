...
@section('content')
    <div class="w-full md:w-3/4 mx-auto p-6 md:p-8 lg:p-9 mt-24 bg-none md:bg-[#F6D2FF] rounded-none md:rounded-3xl drop-shadow-lg font-poppins">
        ...
        <form id="pendaftaranForm" action="{{ route('pendaftaranSMA.store') }}" method="POST" enctype="multipart/form-data"
            class="mx-auto max-w-sm sm:max-w-md md:max-w-2xl lg:max-w-3xl border-t-2 border-purple-400 px-6 py-4">
            @csrf
            ...
            <div id="step-5" class="step hidden">
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="surat_rekomendasi" class="block border-2 rounded text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-l file:border-0 file:text-sm file:font-semibold file:bg-gray-600 file:text-white hover:file:bg-gray-500 w-full">
                </div>
            </div>
